...
public class JobController {
	...
	public ResponseEntity<Optional<JobPostDTO>> getjobById(@PathVariable("postId") UUID postId) {
	...
	public ResponseEntity<JobPostDTO> updateJob(@Valid @RequestBody JobPostDTO jobPostDto,@PathVariable("postId") UUID postId) throws Exception {
